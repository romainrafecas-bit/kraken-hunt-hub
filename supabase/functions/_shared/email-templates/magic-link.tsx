  ...
  <Html lang="fr" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>Connexion en un clic</Heading>
        <Text style={text}>
          Clique sur le bouton ci-dessous pour te connecter à <strong>{siteName}</strong>.
          Ce lien expire rapidement.
        </Text>
        <Section style={{ textAlign: 'center', margin: '28px 0' }}>
          <Button style={button} href={confirmationUrl}>Se connecter</Button>
        </Section>
        <Text style={footer}>Si tu n'as pas demandé ce lien, ignore cet email.</Text>
      </Container>
    </Body>
  </Html>
)
